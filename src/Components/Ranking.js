...
function Ranking() {
    ...
    let handleSubmit = async e => {
        ...
        async function callAPI() {
            ...
            const req = await fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=3d394d515ac4b2c8e6f6727887a4a175&language=es-ES')
    ...
    return <section className="bg-image y-4 mb-5 position-relative h">
        ...
        <div className="jumbotron">
            ...
            <div className="container mb-5 text-center text-white text-shadow ">
                <h1 className="font-italic position-relative ">Películas mejor valoradas</h1>
            </div>
